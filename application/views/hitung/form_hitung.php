        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
               ...
               <div class="ibox-content">
                    <form method="POST" action="<?=base_url()?>hitung/action/<?php if(!empty($data)) echo $data[0]->id_kriteria; ?>" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <select name="nama_kriteria" class="form-control" required="true">
                                ...
                                <option value="Pelayanan" <?php if($data[0]->nama_kriteria == 'Pelayanan') echo 'Selected';?>> Pelayanan  </option>
